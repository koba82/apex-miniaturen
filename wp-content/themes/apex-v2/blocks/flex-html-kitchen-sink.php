    ...
    <div class="content">
        <div class="spaces-sink">
            ...
            <style>
                ...
                .spaces-sink-wrap > div {
                    margin-right: var(--sink-space);
                    width: 25px;
                    height: 25px;
                ...
                .spaces-sink-space-xxs > div {
                    --sink-space: var(--space-xxs);
                }

                .spaces-sink-space-xs > div {
                    --sink-space: var(--space-xs);
                }

                .spaces-sink-space-sm > div {
                    --sink-space: var(--space-sm);
                }

                .spaces-sink-space-md > div {
                    --sink-space: var(--space-md);
                }

                .spaces-sink-space-lg > div {
                    --sink-space: var(--space-lg);
                }

                .spaces-sink-space-xl > div {
                    --sink-space: var(--space-xl);
                }

                .spaces-sink-space-xxl > div {
                    --sink-space: var(--space-xxl);
                }

            </style>
            <code>var(--space-xxs)</code><br/><br/>
            <div class="spaces-sink-wrap spaces-sink-space-xxs">
                <div></div><div></div><div></div><div></div><div></div><div></div>
            </div>
            <code>var(--space-xs)</code><br/><br/>
            <div class="spaces-sink-wrap spaces-sink-space-xs">
                <div></div><div></div><div></div><div></div><div></div><div></div>
            </div>
            <code>var(--space-sm)</code><br/><br/>
            <div class="spaces-sink-wrap spaces-sink-space-sm">
                <div></div><div></div><div></div><div></div><div></div><div></div>
            </div>
            <code>var(--space-md)</code><br/><br/>
            <div class="spaces-sink-wrap spaces-sink-space-md">
                <div></div><div></div><div></div><div></div><div></div><div></div>
            </div>
            <code>var(--space-lg)</code><br/><br/>
            <div class="spaces-sink-wrap spaces-sink-space-lg">
                <div></div><div></div><div></div><div></div><div></div><div></div>
            </div>
            <code>var(--space-xl)</code><br/><br/>
            <div class="spaces-sink-wrap spaces-sink-space-xl">
                <div></div><div></div><div></div><div></div><div></div><div></div>
            </div>
            <code>var(--space-xxl)</code><br/><br/>
            <div class="spaces-sink-wrap spaces-sink-space-xxl">
                <div></div><div></div><div></div><div></div><div></div><div></div>
            </div>
