...
<div class="stock <?php echo esc_attr( $class ); ?>">
    ...
    <?php switch($class) {
        ...
        case "available-on-backorder" :
            ...
            elseif($dccStock !== '' && $dccStock !== NULL && $dccStock !== false ) :
                echo '<p><span class="icon-wrap small">' . display_icon('fnd-success-alt') . '</span>Op voorraad</p>';
                echo '<p><span class="icon-wrap small">' . display_icon('truck-delivery') . '</span>Levertijd ca. 5 werkdagen</p>';
            elseif(strpos($mcwStock, 'available') !== false ) :
                echo '<p><span class="icon-wrap small">' . display_icon('fnd-success-alt') . '</span>Op voorraad bij leverancier</p>';
                echo '<p><span class="icon-wrap small">' . display_icon('truck-delivery') . '</span>Levertijd ca. 10 werkdagen</p>';
            else:
