...
if ( ! empty( $product_tabs ) ) : ?>
    <section class="row content-tabs-row bgc bgc-extend additional-color-4 border-top border-bottom">
         <?php foreach ( $product_tabs as $key => $product_tab ) : ?>
            ...
            //We want to wrap 'description' and 'additional_information' in 1 section wrap. Then we want to wrap 'reviews' in it's own section wrap
            if($key !== 'additional_information') : ?>

                <section class="content-wrap bgc bgc-extend additional-color-4 content-<?=$key;?>-wrap">
                <div class="content">
