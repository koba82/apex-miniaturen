...
<!DOCTYPE html>
<html <?php language_attributes(); ?> class="nav-closed">
...
<head>
	...
	{"@context":"http:\/\/schema.org","@type":"WebSite","url":"<?php echo site_url(); ?>","name":"<?php bloginfo( 'name' ); ?>","potentialAction":{"@type":"SearchAction","target":"<?php echo site_url(); ?>?s={search_term_string}","query-input":"required name=search_term_string"}}
    </script>
