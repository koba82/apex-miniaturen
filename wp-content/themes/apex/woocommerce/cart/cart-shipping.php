        ...
        <?php if ( 1 < count( $available_methods ) ) : ?>
            <tr class="shipping">
                <?php foreach ( $available_methods as $method ) : ?>
                        ...
                        <?php
                        printf( '<th><label for="shipping_method_%1$d_%2$s">%5$s</label></th>
                                 <td><input type="radio" name="shipping_method[%1$d]" data-index="%1$d" id="shipping_method_%1$d_%2$s" value="%3$s" class="shipping_method" %4$s /></td>',
