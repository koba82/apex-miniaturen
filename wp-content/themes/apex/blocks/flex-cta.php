...
<section class="content-wrap block-cta-cards <?php getBackgroundColor(); ?>">
    <div class="content">
        ...
        <div class="flex-cta card-container" data-cards="<?=$number_of_cards;?>">
            ...
            $attr_bgc = ($attr_bgc_value !== 'geen') ? 'bgc' : '';
            $attr_target = ($open_new_window) ? 'target="_blank"' : '';

            if($card_link) : ?>
            <a href="<?=$cta_link;?>" <?=$attr_target; ?> class="flex-cta-button-wrap card <?=$attr_bgc;?> <?=$attr_bgc_value; ?> <?=$attr_bg_img;?>">
                <?php else : ?>
